...
public class SubtractionGenerator implements QstnGenerator {
	...
	private QuizQuestion generateGradeOneQuestion() {
		...
		StringBuilder buffer = new StringBuilder("What is  "+ maxInt +  "-" + minInt +" \n");
	...
	public SubtractionGenerator(String academicLevel, int diffLevel) {
		super();
		this.academicLevel = academicLevel;
		this.diffLevel = diffLevel;
	}
